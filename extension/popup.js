...
document.getElementById("gen-digits").addEventListener("change", updateGeneratorUI);
...
btn.innerHTML = "&#10003;";
setTimeout(() => {
btn.innerHTML = '<svg width="18" height="18"><use href="#ico-copy"/></svg>';
}, 1500);
});
}
});
...
// Charger les param�tres, le g�n�rateur et les raccourcis
loadButtonSettings();
updateGeneratorUI();
loadShortcuts();

// �couter les changements d'authentification (connexion via site dans un autre onglet)
