                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700 mb-2">
                                        ...
                                        de chiffrement de toutes vos données.
                                        MemKeyPass n&apos;a aucun moyen de
                                        récupérer ou de réinitialiser ce mot de
                                        passe.
                                    </p>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <p className="text-red-800 text-sm">
                                                <strong>
                                                    ...
                                                    passe principal, vous
                                                    perdrez définitivement
                                                    l&apos;accès à toutes vos
                                                    données chiffrées.
                                                </strong>{" "}
                                                Nous vous recommandons fortement
                                                de le noter dans un endroit sûr.
                                            </p>
                                        </div>
                                    </div>
                                </div>
