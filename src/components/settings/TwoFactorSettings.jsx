        ...
        <Card className="p-6">
            ...
            <div className="mb-6">
                ...
                <p className="text-sm text-gray-600">
                    ...
                    en activant l&apos;authentification à deux facteurs (2FA).
                </p>
            </div>
                ...
                <div className="space-y-4">
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                        ...
                        <p className="text-sm text-gray-600 mb-2">
                            Utilisez Google Authenticator, Microsoft
                            Authenticator, ou toute autre application TOTP
                            compatible.
                        </p>
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                    <strong>Sécurité renforcée :</strong> La 2FA ajoute une
                    couche de protection supplémentaire en demandant un code
                    unique à chaque connexion, même si quelqu&apos;un connaît
                    votre mot de passe.
                </p>
            </div>
        </Card>
